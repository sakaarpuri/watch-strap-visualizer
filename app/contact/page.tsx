...
const title = "Contact Watchstrapper";
const description = "Get in touch with Watchstrapper for enquiries, product ideas, bug reports, and feedback about the watch strap visualizer.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title,
    description,
    url: "https://watchstrapper.com/contact",
    type: "website"
  },
  twitter: {
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: "Home",
      item: "https://watchstrapper.com/"
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Contact",
      item: "https://watchstrapper.com/contact"
    }
  ]
};
